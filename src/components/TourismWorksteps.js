...
const TourismWorksteps = () => {
    ...
    return (
        <StyledWorkstepsSection id="works">
            <Container>
                <SectionHeader text={t("Как мы работаем")} color="#ffffff" subcolor="#ffffff" />
                <StyledWorkstepsItems>
                    <StyledWorkstepsItem>
                        ...
                        <p>{t("Вы оставляете завку на подбор тура")}</p>
                    </StyledWorkstepsItem>
                    <StyledWorkstepsItem>
                        ...
                        <p>{t("Наши специалисты подбирают Вам лучшее предложение")}</p>
                    </StyledWorkstepsItem>
                    <StyledWorkstepsItem>
                        ...
                        <p>{t("Быстро оформляем документы")}</p>
                    </StyledWorkstepsItem>
                    <StyledWorkstepsItem>
